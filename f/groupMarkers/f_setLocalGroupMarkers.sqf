...
// MARKERS: BLUFOR > NLD
// Markers seen by players in NLD slots.
	...
	case "nld_units":
	{
		...
		["GrpNLD_TNK2", 8, "TNK2", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpNLD_TNK3", 8, "TNK3", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpNLD_TNK4", 8, "TNK4", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpNLD_MMG1", 2, "MMG1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpNLD_HMG1", 2, "HMG1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpNLD_MAT1", 3, "MAT1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpNLD_HAT1",  3, "HAT1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpNLD_ST1",  4, "ST1", "ColorOrange"] spawn f_fnc_localGroupMarker;
	};
